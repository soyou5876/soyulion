            ...
            <div className='main'>
                <div>
                    ...
                    <div>
                        ...
                        <div className='info'>머니S |2023.10.21</div>
                    </div>
                </div>
                <div>
                    <img src={Img02} alt='section5' />
                    <div>
                        <h3>P2E'실타래',편의성 강화해 진입장벽 낮춘다 </h3>
                        <div className='text'>멋쟁이사자처럼은 메타콩즈뿐 아니라 여러 갈래의 대체불가토큰(NFT) 사업을 펼쳤다. 멋생이사자처럼 산하 블록...</div>
                        <div className='info'>더별 |2023.01.27</div>
                    </div>
                </div>
                <div>
                    <img src={Img03} alt='section5' />
                    <div>
                ...
                <div>
                    <img src={Img04} alt='section5' />
                    <div>
                        <h3>
                            멋쟁이사자처럼, 아트 NFT·실물 연계 ‘쿼드해시‘ 프로젝트 띄운다</h3>
